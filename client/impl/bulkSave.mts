...
import { TransactionSetupError, TransactionVersionConflictError, TransactionBulkOperationError, TransactionRollbackError } from './utils/transactionErrors.mts';
 ...
 */
export const bulkSaveTransaction = async (config: CouchConfigInput, transactionId: string, docs: CouchDocInput[]): Promise<BulkSaveResponse> => {
